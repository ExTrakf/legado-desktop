...
import io.legado.desktop.data.entities.*
import io.legado.desktop.help.book.isWebFile
import io.legado.desktop.help.coroutine.CompositeCoroutine
import io.legado.desktop.help.coroutine.Coroutine
import io.legado.desktop.help.source.sortUrls
import io.legado.desktop.model.rss.Rss
...
object Debug {
    ...
    fun putDebug(tag: String, msg: String) {
        LogUtils.d(tag, msg)
    }
}