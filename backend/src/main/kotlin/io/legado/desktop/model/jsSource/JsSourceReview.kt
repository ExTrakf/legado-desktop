package io.legado.desktop.model.jsSource
...
import io.legado.desktop.model.analyzeRule.ReviewRuleParser
...
internal object JsSourceReview {
    ...
    private val capabilityCache = SimpleLruCache<String, Boolean>(64)
    private val replyCapabilityCache = SimpleLruCache<String, Boolean>(64)
