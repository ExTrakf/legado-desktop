...
import io.legado.desktop.data.entities.rule.ExploreRule
...
import io.legado.desktop.help.ReplaceAnalyzer
import io.legado.desktop.utils.DebugLog
import io.legado.desktop.utils.GSON
import io.legado.desktop.utils.jsonPath
import io.legado.desktop.utils.readBool
import io.legado.desktop.utils.readInt
    ...
    fun fromOldBookSource(jsonItem: DocumentContext): BookSource {
        ...
        return source.apply {
            bookSourceUrl = jsonItem.readString("bookSourceUrl")
                ?: throw NoStackTraceException("格式不对") // 原 R.string.wrong_format
