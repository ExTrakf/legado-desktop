...
import io.legado.desktop.help.book.removeAllBookType
...
private val exploreInfoMapCache = ConcurrentHashMap<String, InfoMap>()
...
object WebBook {
    ...
    suspend fun exploreBookAwait(
        ...
        val exploreInfoMap = exploreInfoMapCache[sourceUrl]
        val analyzeUrl = AnalyzeUrl(
            mUrl = url,
            page = page,
            baseUrl = sourceUrl,
