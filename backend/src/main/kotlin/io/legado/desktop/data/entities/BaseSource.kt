...
import io.legado.desktop.constant.AppPattern.JS_PATTERN
import io.legado.desktop.data.entities.rule.RowUi
import io.legado.desktop.exception.NoStackTraceException
import io.legado.desktop.help.CacheManager
import io.legado.desktop.help.ConcurrentRateLimiter.Companion.updateConcurrentRate
import io.legado.desktop.help.JsExtensions
import io.legado.desktop.help.config.AppConfig
import io.legado.desktop.help.crypto.SymmetricCryptoAndroid
import io.legado.desktop.help.http.CookieStore
import io.legado.desktop.help.source.clearExploreKindsCache
...
import io.legado.desktop.model.SharedJsScope.remove
import io.legado.desktop.model.jsSource.JsSourceEngine
import io.legado.desktop.model.login.LoginUiV2
...
import io.legado.desktop.utils.has
...
interface BaseSource : JsExtensions {
    ...
    fun getLoginInfo(): String? {
        try {
            val key = "legado-desktop".encodeToByteArray(0, 16)
