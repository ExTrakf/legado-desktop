...
import io.legado.desktop.constant.AppPattern.spaceRegex
...
import io.legado.desktop.utils.escapeRegex
...
class ContentProcessor private constructor(
    ...
    companion object {
        ...
        private val isAndroid8 = false // 桌面版无 Android 8 换行符特殊处理
            ...
            if (useReplace && book.getUseReplaceRule()) {
                ...
                getContentReplaceRules().forEach { item ->
                    ...
                    try {
                        ...
                        LogUtils.e("桌面版","替换净化: 规则 ${item.name}替换出错")
                    }
                }
            }
