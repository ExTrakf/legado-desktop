package io.legado.desktop.model.analyzeRule
...
import io.legado.desktop.constant.AppConst.UA_NAME
...
import io.legado.desktop.help.http.RequestMethod
import io.legado.desktop.help.http.StrResponse
import io.legado.desktop.help.http.addHeaders
import io.legado.desktop.help.http.get
...
import io.legado.desktop.help.http.postForm
import io.legado.desktop.help.http.postJson
import io.legado.desktop.help.http.postMultipart
...
import io.legado.desktop.utils.GSONStrict
...
import io.legado.desktop.utils.get
import io.legado.desktop.utils.isJson
import io.legado.desktop.utils.isJsonArray
import io.legado.desktop.utils.isJsonObject
import io.legado.desktop.utils.isXml
...
class AnalyzeUrl(
    ...
    private fun getClient(): OkHttpClient {
        ...
        val cronetInterceptor = null // 桌面版无 Cronet
    ...
    private fun getByteArrayIfDataUri(): ByteArray? {
        ...
        if (dataUriFindResult != null) {
            ...
            val byteArray = java.util.Base64.getDecoder().decode(dataUriBase64)
            return byteArray
        }
        return null
    }
