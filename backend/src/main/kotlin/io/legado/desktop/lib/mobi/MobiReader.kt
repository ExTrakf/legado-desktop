...
import io.legado.desktop.lib.mobi.entities.ExthRecordType
import io.legado.desktop.lib.mobi.entities.KF8Header
import io.legado.desktop.lib.mobi.entities.MobiEntryHeaders
import io.legado.desktop.lib.mobi.entities.MobiHeader
import io.legado.desktop.lib.mobi.entities.PalmDocHeader
import io.legado.desktop.lib.mobi.utils.readString
import io.legado.desktop.lib.mobi.utils.readUInt16
...
class MobiReader {
    ...
    fun readMobi(file: File): MobiBook {
        val pdbFile = PDBFile(file)
