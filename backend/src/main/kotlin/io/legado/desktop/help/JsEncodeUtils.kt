...
import io.legado.desktop.help.crypto.AsymmetricCrypto
import io.legado.desktop.help.crypto.Sign
...
//******************消息摘要/散列消息鉴别码************************//
    ...
    fun digestBase64Str(
        ...
        return java.util.Base64.getEncoder().encodeToString(DigestUtil.digester(algorithm).digest(data))
    }
